...
def get_news():
    ...
    try:
        ...
        cursor = cnx.cursor()
        cursor.execute('SELECT * FROM napp_news WHERE newsid = "1"')
        news1 = cursor.fetchall()
        cursor.execute('SELECT * FROM napp_news WHERE newsid = "2"')
        news2 = cursor.fetchall()
        cursor.execute('SELECT * FROM napp_config WHERE configkey = "unixtime"')
        unix = cursor.fetchall()
        return news1, news2, unix
...
def get_config():
    ...
    try:
        ...
        cursor = cnx.cursor()
        cursor.execute('SELECT * FROM napp_config WHERE configkey = "code"')
